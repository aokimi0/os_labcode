...
quick_check(){ tag="$1"; shift; show_check_tag "$tag"; check_regexps "$@"; }
...
pts=10
run_test -tag 'buddy pmm' -DPMM_MANAGER_BUDDY -DBUDDY_SELF_TEST -check check_regexps \
